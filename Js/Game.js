...
function preload(){
 roboto=loadFont("text-font/Roboto-Light.ttf")
 raleway=loadFont("text-font/Raleway-Regular.ttf")
 bgMusic=loadSound("audio/bgMusic.mp3")


 s=loadImage("images/square.png")
 t=loadImage("images/triangle.png")
 w=loadImage("images/wall.png")
 p=loadImage("images/pl.png")
 e=loadImage("images/exit.png")
